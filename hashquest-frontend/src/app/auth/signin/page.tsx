          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Card className="glassmorphism border-primary-500/30">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-cyber text-gradient">Welcome Back</CardTitle>
                <p className="text-gray-400 mt-2">Sign in to continue your HashQuest journey</p>
              </CardHeader>
